...
public class peminjaman1 extends javax.swing.JFrame {
    ...
    class tambahbarang extends peminjaman1 {
...
private void updateComboSiswa() {
    ...
    private void initComponents() {
        ...
        tombolgantibarang.setEnabled(false);
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/perpustakaan/8.png"))); // NOI18N
    ...
    if (rs.next()) {
        ...
        refreshTablePinjam();
        refreshTableBalik();
        tombolsimpanbarang.setEnabled(true);
    ...
    private void TabelPinjamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelPinjamMouseClicked
        // TODO add your handling code here:
        tombolsimpanbarang.setEnabled(false);
        tombolgantibarang.setEnabled(true);
...
this.dispose();
    ...
    private void TabelBalikMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelBalikMouseClicked
        ...
        cbSiswa.setEnabled(true);
        TPinjam.setEnabled(true);
